                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('setsoal.store') }}" method="POST">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label
                                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Kategori
                                                        Tes</label>
                                                    <div class="col-sm-12 col-md-7">
                                                        <select name="kategorisoalid" id="" class="form-control">
                                                            ...
                                                            @forelse ($kategori as $item)
                                                                <option
                                                                    {{ old('kategorisoalid') == $item->id ? 'selected' : '' }}
                                                                    value="{{ $item->id }}">{{ $item->namakategori }}
                                                                </option>
                                                            @empty
                                                            @endforelse
                                                        </select>
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <select name="status" id="" class="form-control">
                                                            ...
                                                            <option {{ old('status') == 'pasif' ? 'selected' : '' }}
                                                                value="pasif">Pasif</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <input type="date" name="tanggalselesai" class="form-control"
                                                            placeholder="Tanggal Akhir Selesai"
