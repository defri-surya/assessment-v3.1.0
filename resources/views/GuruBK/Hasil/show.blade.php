        ...
        <div class="row mb-1" style="padding: 12px; background-color: white; ">
                {{-- <div class="col-md-12"> --}}
                    <div class="col-md-6 col-sm-6">
                        <div class="row">
                            <div class="col-md-4">Nama</div><div class="col-md-8">: <span style="color: blue; font-weight: bold">{{ $hasilsemua->nama }}</span></div>
                        </div>
                        <div class="row">
                                <div class="col-md-4">Jenis Kelamin</div><div class="col-md-8">: {{ $hasilsemua->jeniskelamin }}</div>
                        </div>
                        <div class="row">
                                <div class="col-md-4">Tanggal Lahir</div><div class="col-md-8">: {{ Carbon\Carbon::parse($hasilsemua->tanggallahir)->isoFormat('D MMMM Y') }}</div>
                        </div>
                    </div>
        
                    <div class="col-md-6 col-sm-6">
                        <div class="row">
                            <div class="col-md-4">Tanggal Tes</div><div class="col-md-8">: {{ $hasilsemua->created_at }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">Asal Sekolah</div><div class="col-md-8">: {{ $hasilsemua->namasekolah }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">NISN</div><div class="col-md-8">: {{ $hasilsemua->nisn }}</div>
                        </div>
                    </div>
                {{-- </div>     --}}
        </div>
