                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-md">
                            ...
                            <tr>
                              ...
                              <td>{{ $siswa->status }}</td>
                              <td>
                                    <form method="POST" action="{{ route('siswa.destroy', $siswa) }}" onsubmit="return confirm('Hapus Data, Anda Yakin ?')">
                                         @method('DELETE')
                                         @csrf
                                         <a class="btn btn-icon btn-primary" href="{{ route('siswa.edit', $siswa) }}"><i class="far fa-edit"></i></a>
